...
export default function WhyChooseUs({ content }: WhyChooseUsProps) {
  ...
  return (
    <section className="py-24 bg-white overflow-hidden flex flex-col items-center h-screen gap-20">
      ...
      <div className="flex justify-between  p-4  lg:max-w-7xl w-full flex-1 flex-col gap-8 lg:flex-row">
        <div className="relative w-full lg:max-w-2xl flex-1 lg:pt-10">
          <div className="absolute left-0 top-0 w-full lg:w-96  lg:h-96 bg-[#C05E72] rounded-full flex items-center justify-center  text-white z-10 opacity-85">
          ...
          <div className="absolute left-80 top-0 lg:w-96 lg:h-96 bg-gray-100 rounded-full overflow-hidden">
            <img
              src={content?.Feature?.[activeFeature].img?.url ?? ""}
              alt="A person holding a red phone"
              width={1000}
              height={1000}
              className="object-cover  h-full lg:w-96"
            />
          </div>
        </div>
